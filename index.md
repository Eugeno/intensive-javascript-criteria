...
Если существуют несколько разных API позволяющих решить одну и ту же задачу, например поиск элемента по ID в DOM-дереве, то в проекте используется только один из этих способов.
